...
return [
    ...
    'service_manager' => [
        'aliases' => [
            ...
            Repository\PolicyRepositoryInterface::class => Repository\PolicyRepository::class,
        ...
        'factories' => [
            ...
            Repository\PolicyRepository::class => Repository\Factory\PolicyRepositoryFactory::class,
